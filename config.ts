...
const config = {
    ...
    products: [
      {
        ...
        productId: "prod_7Zw9EqoZUd3xwWWkEVEKQ", // Replace with your actual Creem product ID
  ...
  resend: {
    ...
    fromNoReply: `Manus Cloud <noreply@resend.manus-cloud.space>`,
    // REQUIRED — Email 'From' field to be used when sending other emails, like abandoned carts, updates etc..
    fromAdmin: `Admin at Manus Cloud <admin@resend.manus-cloud.space>`,
    // Email shown to customer if they need support. Leave empty if not needed => if empty, set up Crisp above, otherwise you won't be able to offer customer support."
    supportEmail: "support@resend.manus-cloud.space",
  },
  colors: {
